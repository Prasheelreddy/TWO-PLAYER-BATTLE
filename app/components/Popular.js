...
function Navbar({ selected, onUpdateLanguage }) {
...
export default function Popular() {
    ...
    return (
        <>
            <Navbar selected={selectedLanguage} onUpdateLanguage={setSelectedLanguage} />
            {isLoading() && <Loading text="Fetching Repos" ></Loading>}
